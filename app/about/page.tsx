...
const values = [
  {
    ...
    description:
      "Log your exercises, weights, sets and reps with a simple, fast interface.",
  },
  {
    icon: Target,
    title: "Set goals",
    description:
      "Watch your volume grow over time and try to beat your past records.",
  },
  {
    icon: Clock,
    title: "Review history",
    description:
      "Look back at your previous workouts to see exactly what you did last time.",
  },
];
    ...
    <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Your personal companion for building a stronger, healthier version of
          yourself.
        </p>
      </div>
